...
Examining performance of smaller nets on the inner strength USD series' with balancing
by undersampling. Classification only.
"""
...
Spec = WorkSpec('june_6_2017b', pipeline_work_units)
